...
export default function Templates() {
  const { items: defaultTemplates, loading: loadingDefault } = useTemplates(0);
  const { items: customTemplates, loading: loadingCustom } = useTemplates(1);
          ...
          <Tabs>
            ...
            >
              <div className="grid xl:grid-cols-3 grid-cols-2 sm:grid-cols-1 gap-10 my-6">
                ...
                {!loadingDefault && (defaultTemplates || []).length === 0 && (
                      ...
                      <div className="px-4 py-3 w-full">
                        ...
                        <div className="flex justify-around mt-2">
                          <button
                            ...
                            onClick={() => deleteTemplate(c.templateId)}
                          >
                            <IconDeleteStroked />
