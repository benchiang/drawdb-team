...
const zh = {
  translation: {
    ...
    rename: "重命名",
    delete_diagram: "删除图表",
    are_you_sure_delete_diagram: "确定要删除此图表吗？它将移至回收站，可随时恢复。",
    are_you_sure_delete_table: "确定要删除此表吗？此操作不可逆转。",
    move_to_recycle_bin: "已移至回收站",
    move_to_recycle_bin_failed: "移至回收站失败",
    recycle_bin: "回收站",
    ...
    are_you_sure_delete_permanently: "确定要永久删除「{{name}}」吗？此操作不可恢复。",
    permanent_delete_failed: "永久删除失败",
    empty_recycle_bin: "清空回收站",
    are_you_sure_empty_recycle_bin: "确定要清空回收站吗？所有图表将永久删除，无法恢复。",
    empty_recycle_bin_success: "回收站已清空",
    empty_recycle_bin_failed: "清空回收站失败",
    trashed_at: "删除于",
